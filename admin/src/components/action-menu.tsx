 ...
 */
export function ActionMenu({ items, align = 'right', label = 'Row actions' }: ActionMenuProps) {
  ...
  const dropdownNode = open
    ? createPortal(
        <div
          ...
          role="menu"
          style={menuStyle}
          className="min-w-[12rem] rounded-lg border border-border bg-popover p-1 text-sm shadow-md"
        >
          {items.map((entry, idx) => {
