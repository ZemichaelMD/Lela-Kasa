...
async function downloadCsv(res: Response, filename: string) {
                ...
                rows.map((r) => (
                  ...
                  >
                    ...
                    <Td right>
                      <span
                        className={
                          (r.creditCents ?? 0) > 0 ? "text-amber-600" : ""
                        }
                      >
...
function CreditAgingTab({
  ...
  function handleExport(_format: ExportFormat) {
    setExporting(true);
    sdk.reports
      .exportCreditAging({ dateFrom, dateTo })
      .then((res) => downloadCsv(res, `credit-aging-${dateFrom}-${dateTo}.csv`))
      .catch(() => {})
      .finally(() => setTimeout(() => setExporting(false), 500));
  }
